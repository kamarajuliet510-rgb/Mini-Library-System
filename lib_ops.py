...
slgs_books = {}  # Key: ISBN (str), Value: dict {'title': str, 'author': str, 'genre': str, 'total_copies': int}
slgs_members = []  # List of dicts {'member_id': int, 'name': str, 'email': str, 'borrowed_books': list[str]}
slgs_genres = ('Fiction', 'Non-Fiction', 'Sci-Fi')  # Immutable tuple - prevents accidental changes to allowed genres
